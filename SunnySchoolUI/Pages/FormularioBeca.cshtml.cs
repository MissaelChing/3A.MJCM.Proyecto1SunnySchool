...
namespace SunnySchoolUI.Pages
{
    public class FormularioBecaModel : PageModel
    {
        ...
        public readonly IRepositorySolicitud<SolicitudM> repositorysolicitar;
        public FormularioBecaModel(IRepositorySolicitud<SolicitudM> repositorysolicitar)
        {
        ...
        public IActionResult OnPost()
        {
            ...
            return Redirect("/Pages/Index?id=" + solicitudM.Id);
        }
    }
}