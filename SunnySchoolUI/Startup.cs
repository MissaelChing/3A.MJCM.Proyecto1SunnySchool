...
namespace GestionDeBecas
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRepositoryRegistroEvaluador, Evaluador>();
            services.AddScoped<IRepositorySolicitud, Solicitud>();
            services.AddScoped<IRepositoryAlumno, AlumnoS>();
            services.AddScoped<IRepositorySolicitudSocioe, Socioeconomicos>();
